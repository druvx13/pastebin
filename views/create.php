...
/*
 * views/create.php
 * Rendered inside <section> when no paste is being viewed.
 * Expects: $languages (set by src/helpers.php).
 */
?>
...
<?php if (isset($_GET['err'])): ?>
  <div class="mb-3 text-sm text-red-600">
    <?php
      $errCode = $_GET['err'];
      if ($errCode === 'empty')           echo 'Content cannot be empty.';
      elseif ($errCode === 'db')          echo 'A database error occurred.';
      elseif ($errCode === 'badtoken')    echo 'Invalid token provided for deletion.';
      elseif ($errCode === 'notfound')    echo 'Paste not found.';
      elseif ($errCode === 'commenttoolong') echo 'Comment too long.';
...
<form method="post" class="space-y-4">
  ...
  <div>
    ...
    <input name="title" maxlength="255" class="w-full px-3 py-2 border rounded"
  ...
  <div>
    ...
    <textarea name="content" rows="14"
              class="w-full px-3 py-3 border rounded font-mono"
